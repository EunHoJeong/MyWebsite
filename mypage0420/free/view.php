<?php
    ...
    include $_SERVER['DOCUMENT_ROOT'] . "/jeh/mypage0420/free/lib/free_func.php";
...
<html lang="ko" dir="ltr">
	<head>
		...
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/jeh/mypage0420/free/css/greet.css?after3">
		<script src="./js/member_form.js" defer></script>
		<title></title>
	</head>
	<body>
		<header>
                      ...
                      ");
							...
							<div id="ripple2">
                                <?php
                                    ...
                                    while ($ripple_row = mysqli_fetch_array($ripple_result)) {
                                        ...
                                        $ripple_nick = $ripple_row['nicname'];
						...
						<div id="write_button">
                            ...
                            <?php
                                ...
                                if ($_SESSION["user_level"] === "0" || $_SESSION["user_id"] == $id) {
