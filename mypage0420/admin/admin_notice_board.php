...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/jeh/mypage0420/admin/admin_css/admin.css?after5">
	</head>
	<body>
		<header>
		...
		<span>　</span>
			...
			<article>
				<ul class="admin_menu">
					...
					<li id="choice"><a href="admin_notice_board.php">공지사항 관리</a></li>
					<li><a href="admin_algorithm_board.php">알고리즘 관리</a></li>
				...
				<ul id="board_list">
					...
					<form method="post" action="admin_board_delete.php?board=<?='notice_board'?>">
                        <?php
